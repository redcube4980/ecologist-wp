...
普段は別々に活動する様々な団体や個人が<br class="sp">協力し合って奏でるハーモニーが、<br class="tab">生物多様性の向上や地域課題の解決へと<br class="sp">つながっていく……<br class="tab">私たちはそのお手伝いをしています。</p></div>
	<div id="overview-link"><a href="#" class="overview-link"><img class="overview-image" src="<?php echo( get_stylesheet_directory_uri() ); ?>/images/icon-overview.svg" alt="団体概要 OVERVIEW"/></a></div>
	</section>
